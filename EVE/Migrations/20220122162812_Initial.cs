        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BusDriverPic = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BusPhoto = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    StartLineDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EndLineDate = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BusDrivers_BusInfos", x => new { x.BusDriverID, x.BusInfoID });
                    table.ForeignKey(
                        name: "FK_BusDrivers_BusInfos_BusDrivers_BusDriverID",
                        column: x => x.BusDriverID,
                        principalTable: "BusDrivers",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BusDrivers_BusInfos_BusInfos_BusInfoID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TicketCarts_BusInfos_BusInfoID",
                        column: x => x.BusInfoID,
                        principalTable: "BusInfos",
                        principalColumn: "ID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderTickets_BusInfos_BusId",
                        column: x => x.BusId,
                        principalTable: "BusInfos",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BusDrivers_BusInfos_BusInfoID",
                table: "BusDrivers_BusInfos",
                column: "BusInfoID");

            migrationBuilder.CreateIndex(
                name: "IX_OrderTickets_BusId",
                table: "OrderTickets",
                column: "BusId");
